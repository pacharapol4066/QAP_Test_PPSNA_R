...
comment_nlp_meiji <- read_excel("E:/master_BADS/IS BADS/Product-Position-SNA/output/comment_cooc_freq.xlsx")
row_names <- as.matrix(comment_nlp_meiji[,1])   # Get col name
#comment_nlp_meiji <- comment_nlp_meiji[2:196]   # Remove first col

comment_nlp_meiji <- comment_nlp_meiji[0:-12,0:-13]
